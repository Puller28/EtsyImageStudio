...
## Recent Changes
- **Updated Pricing Plans (August 20, 2025)**: Updated all subscription plan descriptions to reflect the new free mockup access. Free plan now includes "Free mockup generation (2 mockups at 1 credit each)" while Pro and Business plans specify "Premium mockup generation (5 templates at 3 credits each)" for clarity.
- **Free User Mockup Access (August 20, 2025)**: Added free mockup generation for all users. Free users can generate up to 2 mockups at 1 credit each, while paid users get up to 5 mockups at 3 credits each. This provides free users with a taste of the mockup functionality to encourage upgrades while maintaining cost efficiency with the local template API integration.
