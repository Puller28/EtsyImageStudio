...
## Recent Changes
- **Unlimited Free Mockups (August 20, 2025)**: Removed artificial mockup limits for free users. Free users now get unlimited mockups at 1 credit each, naturally limited only by their 100 monthly credits. This provides much better value while encouraging natural credit consumption and upgrades for premium features.
- **Updated Pricing Plans (August 20, 2025)**: Updated all subscription plan descriptions to reflect unlimited free mockup access. Free plan now includes "Unlimited mockup generation (1 credit each, limited by monthly credits)" while Pro and Business plans specify "Premium mockup generation (5 templates at 3 credits each)" for clarity.
