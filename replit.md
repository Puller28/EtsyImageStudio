...
## Recent Changes
- **Simplified Mockup Pricing (August 20, 2025)**: Unified mockup pricing to 1 credit per mockup across all user tiers (free, pro, business). Free users get 100 mockups with their 100 monthly credits, while paid users benefit from higher credit allocations. This simplifies the pricing structure and provides clear value scaling.
- **Updated Pricing Plans (August 20, 2025)**: Updated all subscription plan descriptions to reflect unified mockup pricing. All plans now include "Unlimited mockup generation (1 credit each)" with natural scaling based on credit allocation per plan.
