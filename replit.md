...
- **Credit Cost Alignment (August 21, 2025)**: Updated billing page to reflect actual system costs: AI generation (2 credits), 2x upscaling (1 credit), 4x upscaling (2 credits), Etsy listings (2 credits), mockup generation (3 credits per set). Fixed discrepancy where billing showed 1 credit for Etsy listings and 5 credits for mockups.
